...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=M+PLUS+Rounded+1c:wght@400;500;700&family=Fraunces:ital,wght@0,700;1,700&display=swap');
        * { box-sizing: border-box; }
        ...
        .app-title { font-size: 17px; color: #2A90BF; font-weight: 700; font-style: italic; letter-spacing: 0.01em; white-space: nowrap; font-family: 'Fraunces', serif; }
