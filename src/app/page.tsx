...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=M+PLUS+Rounded+1c:wght@400;500;700&family=Noto+Sans:wght@700;900&display=swap');
        * { box-sizing: border-box; }
        ...
        .app-title { font-size: 17px; color: #2A90BF; font-weight: 900; letter-spacing: 0.03em; white-space: nowrap; font-family: 'Noto Sans', sans-serif; }
