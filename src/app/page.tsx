    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .app-title { font-size: 16px; color: #2A90BF; font-weight: 600; letter-spacing: 0.12em; white-space: nowrap; font-family: 'Josefin Sans', sans-serif; text-transform: uppercase; }
