...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=M+PLUS+Rounded+1c:wght@400;500;700&family=Syne:wght@700;800&display=swap');
        * { box-sizing: border-box; }
        ...
        .app-title { font-size: 17px; color: #2A90BF; font-weight: 800; letter-spacing: 0.03em; white-space: nowrap; font-family: 'Syne', sans-serif; }
