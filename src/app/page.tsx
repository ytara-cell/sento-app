...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=M+PLUS+Rounded+1c:wght@400;500;700&family=Chango&display=swap');
        * { box-sizing: border-box; }
        ...
        .app-title { font-size: 17px; color: #2A90BF; font-weight: 400; letter-spacing: 0.02em; white-space: nowrap; font-family: 'Chango', sans-serif; }
